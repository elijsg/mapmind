    ...
    return (
        <div className={styles.tryNowContainer}>
            <div className={styles.tryNowSubContainer}>
                <div className={styles.tryNowBlockLeft}>
                    <p className={styles.tryNowText}>
                      ...
                      <span className={styles.boldWord}> anyone</span> discover their full potential. Sometimes we need a litte help finding our true capability.
                    </p>
                    <p className={styles.tryNowText}>
            ...
            <div className={styles.tryNowBlock}>
                <img className={styles.tryNowImage} src="/images/try.png" alt="Jump" />
            </div>
